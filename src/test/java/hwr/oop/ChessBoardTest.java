...
class ChessBoardTest {
  ...
  void testInitialBoardSetup() {
    ...
    assertThat(actualBoard.get(0).get(0))
        ...
        .isEqualTo(new Rook(Color.BLACK, new Position(0, 0)));
    assertThat(actualBoard.get(0).get(7))
        .usingRecursiveComparison()
        .isEqualTo(new Rook(Color.BLACK, new Position(0, 7)));
    assertThat(actualBoard.get(7).get(0))
        .usingRecursiveComparison()
        .isEqualTo(new Rook(Color.WHITE, new Position(7, 0)));
    assertThat(actualBoard.get(7).get(7))
        .usingRecursiveComparison()
        .isEqualTo(new Rook(Color.WHITE, new Position(7, 7)));

    // Test for Knights
    assertThat(actualBoard.get(0).get(1))
        .usingRecursiveComparison()
        .isEqualTo(new Knight(Color.BLACK, new Position(0, 1)));
    assertThat(actualBoard.get(0).get(6))
        .usingRecursiveComparison()
        .isEqualTo(new Knight(Color.BLACK, new Position(0, 6)));
    assertThat(actualBoard.get(7).get(1))
        .usingRecursiveComparison()
        .isEqualTo(new Knight(Color.WHITE, new Position(7, 1)));
    assertThat(actualBoard.get(7).get(6))
        .usingRecursiveComparison()
        .isEqualTo(new Knight(Color.WHITE, new Position(7, 6)));

    // Test for Bishops
    assertThat(actualBoard.get(0).get(2))
        .usingRecursiveComparison()
        .isEqualTo(new Bishop(Color.BLACK, new Position(0, 2)));
    assertThat(actualBoard.get(0).get(5))
        .usingRecursiveComparison()
        .isEqualTo(new Bishop(Color.BLACK, new Position(0, 5)));
    assertThat(actualBoard.get(7).get(2))
        .usingRecursiveComparison()
        .isEqualTo(new Bishop(Color.WHITE, new Position(7, 2)));
    assertThat(actualBoard.get(7).get(5))
        .usingRecursiveComparison()
        .isEqualTo(new Bishop(Color.WHITE, new Position(7, 5)));

    // Test for Queens
    assertThat(actualBoard.get(0).get(3))
        .usingRecursiveComparison()
        .isEqualTo(new Queen(Color.BLACK, new Position(0, 3)));
    assertThat(actualBoard.get(7).get(3))
        .usingRecursiveComparison()
        .isEqualTo(new Queen(Color.WHITE, new Position(7, 3)));

    // Test for Kings
    assertThat(actualBoard.get(0).get(4))
        .usingRecursiveComparison()
        .isEqualTo(new King(Color.BLACK, new Position(0, 4)));
    assertThat(actualBoard.get(7).get(4))
        .usingRecursiveComparison()
        .isEqualTo(new King(Color.WHITE, new Position(7, 4)));

    // Test for Pawns
    for (int i = 0; i < 8; i++) {
      assertThat(actualBoard.get(1).get(i))
          .usingRecursiveComparison()
          .isEqualTo(new Pawn(Color.BLACK, new Position(1, i)));
      assertThat(actualBoard.get(6).get(i))
          .usingRecursiveComparison()
          .isEqualTo(new Pawn(Color.WHITE, new Position(6, i)));
    }
  }
  ...
  void movePiece_Successful() throws MovePieceException {
    ...
    assertThat(actualBoard.get(5).getFirst())
        .usingRecursiveComparison()
        .isEqualTo(new Pawn(Color.WHITE, new Position(5, 0)));
  }
  ...
  void movePiece_Fail_OutsideBoardNegativeColumn() {
    ...
    MovePieceException exception =
        assertThrows(MovePieceException.class, () -> board.movePiece(from, to));
    String expectedMessage = "Invalid destination position!";
    assertThat(exception.getMessage()).contains(expectedMessage);
    assertThat(actualBoard.get(6).getFirst())
        .usingRecursiveComparison()
        .isEqualTo(new Pawn(Color.WHITE, new Position(6, 0)));
  }
