...
class TaskTest {
    ...
    @Test
    void getDeadline() {
        Task example = new Task("Title","Content", TaskState.IN_PROGRESS, LocalDateTime.now());
    ...
    void completeTaskSuccessfully(TaskState state) {
        Task test = new Task("title", "content", state, LocalDateTime.now());
        try {
            test.completeTask();
    ...
    void resetTaskSuccessfullyTest() {
        Task test = new Task("title", "content", TaskState.IN_PROGRESS, LocalDateTime.now());
        try {
            test.resetTask();
